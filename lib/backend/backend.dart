...
import 'schema/memories_collection_record.dart';
...
export 'schema/memories_collection_record.dart';
...
/// Functions to query MemoriesCollectionRecords (as a Stream and as a Future).
Stream<List<MemoriesCollectionRecord>> queryMemoriesCollectionRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      MemoriesCollectionRecord.collection,
...
Future<List<MemoriesCollectionRecord>> queryMemoriesCollectionRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<MemoriesCollectionRecord>>
    queryMemoriesCollectionRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
